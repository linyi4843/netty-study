...
public interface RecvByteBufAllocator {
     ...
     */
    // 作用是预测byteBug的大小.正好合适,不能太小也不能太大
    Handle newHandle();
    ...
    interface Handle {
         ...
         */
        // 分配byteBuf缓冲器对象的接口,参数很重要! 提供预测分配的对象
        // 真正分配内存的 alloc
         ...
         */
        // 判断是否继续读循环 -> do-while   nioMessageUnsafe.read  nioByteUnsafe.read
